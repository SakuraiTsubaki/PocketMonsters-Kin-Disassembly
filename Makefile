...
.PHONY: help verify-reference analyze-bank00 map-bank00-modules extract-bank00-western-text test-bank00-vectors test-bank00-vblank test-bank00-delay test-bank00-time-palettes-fade test-bank00-lcd test-bank00-time test-bank00-init test-bank00-serial test-bank00-joypad test-bank00-decompress test-bank00-palettes test-bank00-gfx test-bank00-text-ranges test-bank00-western-text-strings status
...
status:
	...
	@echo "Western Bank 00 embedded text locale data: EN/DE/FR/IT/ES reconstructed and regression-tested."
