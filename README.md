...
Target-specific research, tooling, and analysis for **Pocket Monsters Kin / Pokémon Gold**.
...
| Intended scope | Japanese and localized Gold releases, with compatibility and revision differences documented explicitly. |
