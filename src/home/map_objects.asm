; Bank 00 map-object helpers shared by all tracked Gold releases.
; Retail ROMs use the same semantic routine set and total size (0x310 bytes);
; only relocated RAM/code addresses differ by release. Public disassemblies are
; used for symbol-name cross-checking; the reference ROMs remain authoritative.
