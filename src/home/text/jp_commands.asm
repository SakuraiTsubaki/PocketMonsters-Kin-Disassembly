; Japanese Gold Bank 00 text command dispatcher.
; Rev 0 and Rev A share this command family byte-for-byte. Japanese Gold does
; not carry the later western/Korean TX_FAR entry.
